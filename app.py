...
fuel_repository = FuelRepository(DATABASE_PATH)
fuel_repository.bootstrap_from_seed(SEED_DATA_PATH)
...
def index():
    ...
    bootstrap = {
        ...
        "ui": {
            ...
            "defaultTankCapacityLabel": f"{vehicle_lookup[default_vehicle]['tankCapacity']:.1f} gal",
            "defaultFuelTypeLabel": vehicle_lookup[default_vehicle]["fuelType"].title(),
